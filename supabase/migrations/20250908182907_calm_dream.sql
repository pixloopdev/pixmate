...
-- This migration adds customer management and payment tracking functionality

-- Create payment status enum
CREATE TYPE IF NOT EXISTS payment_status AS ENUM ('pending', 'paid', 'overdue', 'cancelled');
